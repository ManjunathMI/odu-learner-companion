...
export default function WallPage() {
  ...
  return <main className="wall">
    ...
    <style jsx>{`
      ...
      .wall-header{display:flex;flex-direction:column;align-items:center;text-align:center;gap:1.5rem;margin-bottom:4rem;padding-bottom:2.25rem;border-bottom:1px solid var(--border-color)}
      ...
      .wall-header h1{font-size:3.5rem;max-width:720px;margin:0 auto;line-height:1.05}
      .intro{max-width:610px;margin:1.25rem auto 0;color:var(--text-secondary);font-size:1.1rem}
      .header-note{display:inline-flex;align-items:center;gap:.6rem;padding:.75rem 1.5rem;border-top:3px solid var(--accent-secondary);color:var(--text-secondary);font-size:.9rem}
      ...
      @media(max-width:720px){.wall{padding:3rem 1rem 4rem}.wall-header{gap:1.25rem;margin-bottom:2.75rem}.wall-header h1{font-size:2.55rem}.header-note{max-width:none;flex-direction:column;gap:.35rem}.section-heading{align-items:start}.discovery-controls{grid-template-columns:1fr}.card-footer{align-items:flex-start;flex-direction:column}}
    `}</style>
  </main>;
}
